...
@section('page-title','| Examiner - Add New')
...
@section('content-header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('examiners.index') }}">Examiners List</a></li>
            <li class="breadcrumb-item active">Add New Examiner</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Adding Examiner</h3>
                    </div>
                    @if ($errors->any())
                    ...
                    @endif
                    <!-- form start -->
                    <form id="examiner-form" class="form-horizontal" action="{{ route('examiners.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
