...
@section('page-title','| EPAS Concern Requests')
...
@section('content-header')
    <div class="col-sm-6">
        <h1>EPAS Concern Requests</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">EPAS Concern Requests</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-bordered" id="epas-concern-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Trainer</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            $('#epas-concern-table').DataTable({
                processing: true,
                serverSide: true,
                iDisplayLength: 25,
                aLengthMenu: [[25, 50, 75, 100], [25, 50, 75, 100]],
                ajax: "{{ route('support-requests.epas-concern.data') }}",
                columns: [
                    {data: 'id', name: 'id'},
