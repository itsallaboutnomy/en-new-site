...
@section('page-title','| Suggestions Requests')
...
@section('content-header')
    <div class="col-sm-6">
        <h1>Suggestions Requests </h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Suggestions Requests</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-bordered" id="suggestions-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
    ...
    <script type="text/javascript">
        $(function () {
            $('#suggestions-table').DataTable({
                ...
                ajax: "{{ route('support-requests.suggestions.data') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
