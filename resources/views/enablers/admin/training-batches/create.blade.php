...
@section('page-title','| Training Batches - Add New')
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Adding Training Batch</h3>
                    </div>
                    @if ($errors->any())
                ...
                @endif
                <!-- form start -->
                    <form id="training-batches-form" class="form-horizontal" action="{{ route('training-batches.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Training Batch Name" value="{{ old('name') }}" minlength="3" maxlength="100"/>
                                </div>
                            </div>
                            <div class="row">
...
@section('scripts')
    <script>
        $("#training-batches-form").validate({
