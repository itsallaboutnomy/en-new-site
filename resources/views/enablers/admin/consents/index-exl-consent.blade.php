...
@section('page-title','| EXL Consents')
...
@section('content-header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">EXL Consents</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-bordered" id="exl-consent-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            $('#exl-consent-table').DataTable({
                processing: true,
                serverSide: true,
                iDisplayLength: 25,
                aLengthMenu: [[25, 50, 75, 100], [25, 50, 75, 100]],
                ajax: "{{ route('consents.exl-consent.data') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
