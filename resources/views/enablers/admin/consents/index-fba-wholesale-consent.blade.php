...
@section('page-title','| Fba Wholesale  Consents')
...
@section('content-header')
    <div class="col-sm-6">
        <h1>Fba Wholesale  Consents</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Fba Wholesale  Consents</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body table-responsive">
                        <table class="table table-bordered" id="fba-wholesale-consent-table">
                            <thead>
                            <tr>
                                <th>ID</th>
                                <th>Name</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function () {
            $('#fba-wholesale-consent-table').DataTable({
                processing: true,
                serverSide: true,
                iDisplayLength: 25,
                aLengthMenu: [[25, 50, 75, 100], [25, 50, 75, 100]],
                ajax: "{{ route('consents.fba-wholesale-consent.data') }}",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
