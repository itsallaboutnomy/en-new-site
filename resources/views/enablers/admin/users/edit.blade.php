        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @endif
                    <!-- form start -->
                    <form id="users-form" class="form-horizontal" action="{{ route('users.update',$user->id) }}" method="POSt" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <select name="role" id="role" class="form-control">
                                        @foreach($roles as $key => $value)
                                            <option value="{{ $key }}" {{ $userRole ==  $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
