...
@section('page-title','| Milestones - Add New')
...
@section('content-header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Add New Milestone</li>
        </ol>
    </div>
@endsection
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Adding Milestone</h3>
                    </div>
                    @if ($errors->any())
                    ...
                    @endif
                    <!-- form start -->
                    <form id="milestones-form" class="form-horizontal" action="{{ route('milestones.store') }}" method="POSt" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Milestone Title" value="{{ old('title') }}"/>
                                </div>
                            </div>
                            <div class="form-group row required">
                                <label for="alt_name" class="col-sm-2 col-form-label">Add Sub Title</label>
                                <div class="col-sm-10">
                                    <input type="text" name="sub_title" id="sub_title" class="form-control" placeholder="Milestone Sub Title" value="{{ old('sub_title') }}"/>
                                </div>
                            </div>
                            <div class="form-group row required">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="summary" id="summary" class="form-control" rows="5" placeholder="Detail Description Here..." maxlength="500">{{ old('summary') }}</textarea>
                                </div>
                            </div>
                            <div class="row">
