...
@section('page-title','| Cities - Add New')
...
@section('content-header')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{ route('cities.index') }}">Cities List</a></li>
            <li class="breadcrumb-item active">Add New cities</li>
        </ol>
    </div>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <!-- form start -->
                    <form id="cities-form" class="form-horizontal" action="{{ route('cities.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row required">
                                <label for="name" class="col-sm-2 col-form-label">City Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="City Name" value="{{ old('name') }}" minlength="3" maxlength="100"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 ml-auto text-right pt-4">
                                    <a href="{{ route('cities.index') }}" class="btn btn-default mr-2">Cancel</a>
