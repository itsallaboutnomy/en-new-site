    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                @endif
                <!-- form start -->
                    <form id="roles-form" class="form-horizontal" action="{{ route('roles.update',$role->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="form-group row required">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') ? old('name') : $role->name }}" placeholder="Enter Role Name">
                                </div>
                            </div>
