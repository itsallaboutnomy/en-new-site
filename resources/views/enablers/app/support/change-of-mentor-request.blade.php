...
@section('page-title',' | Change of Mentor Request')
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6 animate__animated animate__animated animate__fadeInLeft">
                        <div class="fr-left-content main-headings">
                            <h1 class="text-white h-primary text-uppercase">Change of Mentor Request</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="fr-forms-wrapper padd mt-5">
        <div class="content">
            <div class="container">
                ...
                <form id="change-of-mentor-request-form" method="POST" action="{{ route('app.support.changeOfMentorRequest.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="request_type" id="request_type" value="change-of-mentor-request">
                    <div class="row my-5">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group required">
                                <label for="no_of_classes" class="label">How Many Classes Student Take?</label>
...
@section('scripts')
    ...
    <script>
        ...
        $("#change-of-mentor-request-form").validate({
