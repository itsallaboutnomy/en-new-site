                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6 animate__animated animate__animated animate__fadeInLeft">
                        <div class="fr-left-content main-headings">
                            <h1 class="text-white h-primary text-uppercase">Suggestions</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="fr-forms-wrapper padd mt-5">
        <div class="content">
            <div class="container">
                ...
                <form id="suggestions-form" method="POST" action="{{ route('app.support.suggestions.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="request_type" id="request_type" value="suggestions">
