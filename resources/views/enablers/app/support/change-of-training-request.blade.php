...
@section('page-title',' | Change of Training Request')
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6 animate__animated animate__animated animate__fadeInLeft">
                        <div class="fr-left-content main-headings">
                            <h1 class="text-white h-primary text-uppercase">Change of Training Request</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="fr-forms-wrapper padd mt-5">
        <div class="content">
            <div class="container">
                ...
                <form id="change-of-training-request-form" method="POST" action="{{ route('app.support.changeOfTrainingRequest.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="request_type" id="request_type" value="change-of-training-request">
...
@section('scripts')
    ...
    <script>
        ...
        $("#change-of-training-request-form").validate({
