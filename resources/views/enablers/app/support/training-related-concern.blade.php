...
@section('page-title',' | Training Related Concern')
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-6 animate__animated animate__animated animate__fadeInLeft">
                        <div class="fr-left-content main-headings">
                            <h1 class="text-white h-primary text-uppercase">Training Related Concern</h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="fr-forms-wrapper padd mt-5">
        <div class="content">
            <div class="container">
                ...
                <form id="training-related-concern-form" method="POST" action="{{ route('app.support.trainingRelatedConcern.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="request_type" id="request_type" value="training-related-concern">
                    <div class="row my-5">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="form-group required">
                                <label for="date" class="label">Class Schedule</label>
...
@section('scripts')
    ...
    <script>
        ...
        $("#training-related-concern-form").validate({
